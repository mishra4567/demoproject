                            ...
                            <div class="card-body">
                                ...
                                @foreach ($productAttrArr as $val)
                                    ...
                                    <div class="mb-3" id="product_attr_{{ $loop_count_num++ }}">
                                        <div class="row">
                                            <input type="hidden" name="paid[]" id="paid" value="{{ $val->id ?? 0 }}">
                                            {{-- product id --}}
                                            <div class="col-md-2">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="hidden" name="media_id[]" id="media_id_attr_{{ $loop_count_prev}}">
                                            ...
                                            <div class="col-md-2">
                                                <div class="mb-3 mt-4">
                                                    @if ($loop_count_num == 2)
                                                        <button id="" type="button" class="btn btn-sm btn-success"
                                                            onclick="add_more()">
